...
// Get pupils attendance
$query = "SELECT AttendanceID, Present, Absent, Lateness, PupilsID, OverallAttendance 
          FROM attendance 
          WHERE PupilsID = $pupilID";
$result = $conn->query($query);
$all_attendance = $result->fetch_all(MYSQLI_ASSOC);
?>

<html>
<head>
  <meta charset="utf-8">
  <title>My Attendance - Student - St Alphonsus Primary School </title>
...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:25%">
  ...
  <a href="Attendance.php" class="w3-bar-item w3-button w3-green">Attendance</a>
...
<div style="margin-left:25%; padding: 20px;">
    ...
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                <?php foreach ($all_attendance as $row): ?>
                    <tr>
