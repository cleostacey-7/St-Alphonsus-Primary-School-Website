...
// Get pupils info
$query = "SELECT PupilsID, FirstName, LastName, Gender, DoB, Address, Medical, DinnerMoney, ClassID 
          FROM pupils 
          WHERE PupilsID = $pupilID";
$result = $conn->query($query);
$all_pupils = $result->fetch_all(MYSQLI_ASSOC);
?>

<html>
<head>
  <meta charset="utf-8">
  <title>My Information - Student - St Alphonsus Primary School </title>
...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:25%">
  ...
  <a href="Student.php" class="w3-bar-item w3-button w3-green">Student Profile</a>
